...
export default hopeTheme({
  ...
  blog: {
    ...
    roundAvatar: true,
    medias: {
      BiliBili: "/assets/images/social-media/bilibili.png",
      ...
      QQ: "/assets/images/social-media/qq.jpg",
      Qzone: "/assets/images/social-media/qzone.png",
      Reddit: "https://www.reddit.com/user/agisnrynt/",
      Twitter: "https://twitter.com/agisnrynt",
      Wechat: "/assets/images/social-media/wechat.png",
      Weibo: "/assets/images/social-media/weibo.png",
